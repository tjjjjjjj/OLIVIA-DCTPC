...
if [[ -z ${ROOTSYS} ]]; then
    ...
    export ROOTSYS=/app/d-Chooz/Software/root/root_v5.30.06
#export ROOTSYS=/app/d-Chooz/Software/root/root_v5.28.00
    export MCTABLES=$PWD/MaxCam/tables
    export LD_LIBRARY_PATH=$PWD/MaxCam:$PWD/cfitsio:$PWD/MaxCam/waveformtools/lib:$ROOTSYS/lib:/app/d-Chooz/Software/lib:/app/d-Chooz/Software/fftw-3.3.3/lib:/app/d-Chooz/Software/gsl-1.15/lib:$PWD/cfitsio/lib:$PWD/MaxCam/Simulations/v1/lib:$LD_LIBRARY_PATH

...
long int new_filesize2=0;
  ...
  tree->Branch("wfr_particleE_1", &leftint, "leftint/D");
  tree->Branch("wfr_particleE_1_ideal", &leftint2, "leftint2/D");
  tree->Branch("wfr_particleE_2", &rightint, "rightint/D");
  tree->Branch("wfr_particleE_2_ideal", &rightint2, "rightint2/D");
  tree->Branch("wfr_DeltaE_Guess",&delta_E,"delta_E/D");
  tree->Branch("wfr_DeltaE_Truth",&delta_E_true,"delta_E_true/D");
  tree->Branch("wfr_DeltaE_Error",&delta_E_err,"delta_E_err/D");
  tree->Branch("wfr_DeltaE_Cheating_Guess",&delta_E_cheat,"delta_E_cheat/D");
  tree->Branch("wfr_DeltaE_Cheating_Error",&delta_E_cheat_err,"delta_E_cheat_err/D");
  tree->Branch("wfr_Origin_Est._A", &jmin, "jmin/I");
  tree->Branch("wfr_Origin_Est._B", &jbragg, "jbragg/I");
  tree->Branch("wfr_Origin_Est._C", &jterm, "jterm/I");
  tree->Branch("wfr_Origin_Est._D", &jterm2, "jterm2/I");
  tree->Branch("wfr_Origin_Est._E", &jterm3, "jterm3/I");
  tree->Branch("wfr_Origin_Est._F", &maxdevloc, "maxdevloc/I");
  tree->Branch("wfr_Origin_Est._C_Fit", &termdist, "termdist/D");
  tree->Branch("wfr_Origin_Truth", &origin, "origin/I");
  tree->Branch("wfr_Origin_Guess", &estimate, "estimate/I");
  tree->Branch("wfr_Origin_Error", &estimate_error, "estimate_error/I");
  //tree->Branch("wfr_RecSD", &rec_SD, "rec_SD/D");
  tree->Branch("wfr_Waveform_Width", &wfd_delta, "wfd_delta/I");
  tree->Branch("wfr_BraggPeak_Loc._1", &peak1, "peak1/I");
  tree->Branch("wfr_BraggPeak_Loc._2", &peak2, "peak2/I");
  tree->Branch("wfr_BraggPeak_Val._1", &peak1val, "peak1val/D");
  tree->Branch("wfr_BraggPeak_Val._2", &peak2val, "peak2val/D");
  tree->Branch("wfr_Bragg_Halfheight_Loc._1", &half1, "half1/I");
  tree->Branch("wfr_Bragg_Halfheight_Loc._2", &half2, "half2/I");
  tree->Branch("wfr_Bragg_Fit_RMS_Left", &rms_left, "rms_left/D");
  tree->Branch("wfr_Bragg_Fit_RMS_Right", &rms_right, "rms_right/D");
  tree->Branch("wfr_Bragg_Fit_RMS_Full", &rms_full, "rms_full/D");
  tree->Branch("wfr_Bragg_Fit_RMS_Outer", &rms_outer, "rms_outer/D");
  ...
  tree->Branch("TRUTH_phi_deg_2", &truth_phi_deg2, "truth_phi_deg2/D");
  ...
  tree->Branch("TRUTH_x_end_mm_2", &truth_x_end_mm2, "truth_x_end_mm2/D");           
  tree->Branch("TRUTH_y_end_mm", &truth_y_end_mm, "truth_y_end_mm/D");
  tree->Branch("TRUTH_y_end_mm_2", &truth_y_end_mm2, "truth_y_end_mm2/D");   
  tree->Branch("TRUTH_x_end_pix", &truth_x_end_pix, "truth_x_end_pix/D");
  tree->Branch("TRUTH_x_end_pix_2", &truth_x_end_pix2, "truth_x_end_pix2/D");  
  tree->Branch("TRUTH_y_end_pix", &truth_y_end_pix, "truth_y_end_pix/D");
  tree->Branch("TRUTH_y_end_pix_2", &truth_y_end_pix2, "truth_y_end_pix2/D");    
  tree->Branch("TRUTH_z_end_mm", &truth_z_end_mm, "truth_z_end_mm/D");
  tree->Branch("TRUTH_z_end_mm_2", &truth_z_end_mm2, "truth_z_end_mm2/D");       
  tree->Branch("TRUTH_theta_deg", &truth_theta_deg, "truth_theta_deg/D");
  tree->Branch("TRUTH_theta_deg_2", &truth_theta_deg2, "truth_theta_deg2/D");         
  tree->Branch("TRUTH_particleE_kev", &truth_particlee_kev, "truth_particlee_kev/D");
  tree->Branch("TRUTH_particleE_kev_2", &truth_particlee_kev2, "truth_particlee_kev2/D");    
  tree->Branch("TRUTH_range_pix", &truth_range_pix, "truth_range_pix/D");
  tree->Branch("TRUTH_range_pix_2", &truth_range_pix2, "truth_range_pix2/D");          
  tree->Branch("TRUTH_range_mm", &truth_range_mm, "truth_range_mm/D");
  tree->Branch("TRUTH_range_mm_2", &truth_range_mm2, "truth_range_mm2/D");             
  tree->Branch("TRUTH_zrange_mm", &truth_zrange_mm, "truth_zrange_mm/D");
  tree->Branch("TRUTH_zrange_mm_2", &truth_zrange_mm2, "truth_zrange_mm2/D");    
...
d.getEvent(i);
 ...
 truth_x_start_mm2=truth_x_start_mm;
 truth_y_start_mm2=truth_y_start_mm;
 truth_x_start_pix2=truth_x_start_pix;
 truth_y_start_pix2=truth_y_start_pix;
 truth_z_start_mm2=truth_z_start_mm;
...
ntrig=mesh->size();
	...
	for (int nt = 0; nt < mesh->size(); nt++)
	{
	  ...
	  delta_E_cheat_err = delta_E_cheat - delta_E_true;

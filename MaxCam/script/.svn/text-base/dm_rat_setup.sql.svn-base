create database RAT_DB;
create table pressure (  value FLOAT NOT NULL, rms FLOAT DEFAULT 0, setval FLOAT, timestamp TIMESTAMP);
...
create table ccd ( temperature FLOAT NOT NULL, exposure INT NOT NULL, daqtime FLOAT DEFAULT 0, avgpixel FLOAT DEFAULT 0, timestamp TIMESTAMP, ccdid INT NOT NULL);
...
create table scope ( scopeid INT NOT NULL, chid INT NOT NULL, nwf INT DEFAULT 0, esum FLOAT DEFAULT 0, timestamp TIMESTAMP);
create table hvstatus ( value FLOAT NOT NULL, rms FLOAT DEFAULT 0, setval FLOAT, timestamp TIMESTAMP);

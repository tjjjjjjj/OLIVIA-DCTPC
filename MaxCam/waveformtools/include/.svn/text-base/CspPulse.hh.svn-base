#ifndef DMTPC_CSP_PULSE
#define DMTPC_CSP_PULSE
...
CspPulse : public DmtpcPulse
{
  ...
  public:
    ...
    */
    ...
    CspPulse(int nb) : DmtpcPulse(nb), 
      R0(-1),R10(-1),R25(-1),R50(-1),R75(-1),R90(-1),
      F0(-1),F10(-1),F25(-1),F50(-1),F75(-1),F90(-1){;}

    CspPulse(const DmtpcPulse& p) : DmtpcPulse(p), 
      R0(-1),R10(-1),R25(-1),R50(-1),R75(-1),R90(-1),
      F0(-1),F10(-1),F25(-1),F50(-1),F75(-1),F90(-1){;}
    ...
    virtual const char* GetName() const {return "CspPulse";}

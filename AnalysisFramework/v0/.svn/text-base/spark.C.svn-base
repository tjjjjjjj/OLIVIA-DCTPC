...
int spark(TString rawdatafiles="files.txt",TString keyfilename = "keys.txt", TString cleandir="./clean/")
{
...
//	    MaxCamImageTools::killLonePixels2(tempimg,1300);
      ...
      cout << "tag a " << nframes[0] << "," << nframes[1] << endl;
	 ...
	 secondarybias[i]->Scale(1/double(nframes[i]));
      ...
      TH2F* pxabove = new TH2F("pxabove","pxabove",500,0,3000,4096,0,65536);

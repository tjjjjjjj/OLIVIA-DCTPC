              ...
              DmtpcSkimDataset & sd, bool delete_intermediate, CleanSkimConfig * conf, unsigned algo_index)
{
 ...
 cout << "Loading complete" << endl;
  ...
  tmpskimtree2->Branch("nwaveform",ncam,"nwaveform/I");
  tmpskimtree2->Branch("leftint",leftint,"leftint/D");
  tmpskimtree2->Branch("leftint2",leftint2,"leftint2/D");
  tmpskimtree2->Branch("rightint",rightint,"rightint/D");
  tmpskimtree2->Branch("rightint2",rightint2,"rightint2/D");
  tmpskimtree2->Branch("jmin",jmin,"jmin/I");
  tmpskimtree2->Branch("jbragg",jbragg,"jbragg/I");
  tmpskimtree2->Branch("jterm",jterm,"jterm/I");
  tmpskimtree2->Branch("jterm2",jterm2,"jterm/I");
  tmpskimtree2->Branch("jterm3",jterm3,"jterm/I");
  tmpskimtree2->Branch("maxdevloc",maxdevloc,"maxdevloc/I");
  tmpskimtree2->Branch("origin",origin,"origin/I");
  
  if (terminator_results.size() > 0)
  {
    for (int i = 0; i < terminator_results.size(); i++)
      tmpskimtree2->Branch("termmatch" + string(i),terminator_results.at(i),"termmatch" + string(i));
  }
 
 tmpskimtree2->Branch("rec_SD",rec_SD,"rec_SD/D");
 tmpskimtree2->Branch("wfd_delta",wfd_delta,"wfd_delta/I");
 tmpskimtree2->Branch("peak1",peak1,"peak1/I");
 tmpskimtree2->Branch("peak2",peak2,"peak2/I");
 tmpskimtree2->Branch("peak1val",peak1val,"peak1val/D");
 tmpskimtree2->Branch("peak2val",peak2val,"peak2val/D");
 tmpskimtree2->Branch("half1",half1,"half1/I");
 tmpskimtree2->Branch("half2",half2,"half2/I");
 tmpskimtree2->Branch("termdist",termdist,"termdist/D");
 tmpskimtree2->Branch("maxdevloc",maxdevloc,"maxdevloc/D");
 tmpskimtree2->Branch("rms_left",rms_left,"rms_left/D");
 tmpskimtree2->Branch("rms_right",rms_right,"rms_right/D");
 tmpskimtree2->Branch("rms_outer",rms_outer,"rms_outer/D");
 tmpskimtree2->Branch("rms_full",rms_full,"rms_full/D");
 tmpskimtree2->Branch("dt",dt,"dt/D");
